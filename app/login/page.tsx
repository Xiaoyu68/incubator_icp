    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden w-1/2 flex-col justify-between bg-primary p-12 lg:flex">
        <Link href="/" className="flex items-center gap-3 transition-opacity hover:opacity-80">
          ...
          <div>
            <h1 className="text-xl font-bold text-primary-foreground">Unitas</h1>
        ...
        <div className="space-y-6">
          <h2 className="text-4xl font-bold leading-tight text-primary-foreground">
            From Raw Intent to{" "}
            <span className="italic">Market Reality</span> in Days.
          </h2>
          <p className="text-lg text-primary-foreground/80">
            Unitas bypasses the guesswork. Our Ethereal Engine stress-tests your
            vision against real-time market signals and synthetic ICPs.
          </p>
        </div>
      ...
      <div className="flex w-full flex-col items-center justify-center bg-background px-8 lg:w-1/2">
        <div className="w-full max-w-md space-y-8">
          ...
          >
            ...
            <div>
              <h1 className="text-xl font-bold text-foreground">Unitas</h1>
